...
def run_alexa():
    ...
    if 'time' in command:
        ...
        tts = gTTS(text='হ্যাঁ আমি সবাইকে ধন্যবাদ জানাচ্ছি হ্যালো বন্ধুরা তোমাদের সবাইকে আমার পক্ষ থেকে ধন্যবাদ',
                   lang='bn')
        tts.save("g.mp3")
        ...
        tts = gTTS(
            text='হ্যা, ঝংকার মাহবুব একজন প্রোগ্রামার, ইউটিউবার, লেখক। উনার লাইফের উল্লেখযোগ্য অর্জনের মধ্যে অন্যতম হচ্ছে-- ক্লাস সেভেনে থাকার সময়, স্ট্যান্ডআপ কমেডিতে দ্বিতীয় স্থান দখল',
            lang='bn')
        tts.save("m.mp3")
