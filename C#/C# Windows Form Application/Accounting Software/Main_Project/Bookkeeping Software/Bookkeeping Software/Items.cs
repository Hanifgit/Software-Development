...
namespace Bookkeeping_Software
{
    public partial class Items : Form
    {
        ...
        {
            string Query = "Select ID,Name,Tax,PDate,EDate,Description,PurchasePrice,SalePrice,Category from Items where IID = '" + Login.Uid +"' ";
        ...
        {
            string Query = "Select ID,Name,Tax,PDate,EDate,Description,PurchasePrice,SalePrice,Category from Items";
