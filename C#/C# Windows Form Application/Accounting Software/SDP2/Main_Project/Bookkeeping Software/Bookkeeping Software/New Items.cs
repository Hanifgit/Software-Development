    ...
    public partial class NewItems : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string IProductDate = ProductDate.Text;
                string IExpireDate = ExpireDate.Text;

                SqlCommand insertCommand = new SqlCommand("insert into Items(Name,Tax,Description,SalePrice,PurchasePrice,Category,IID,PDate,EDate) values(@IName,@ITax,@IDescription,@ISalePrice,@IPurchase,@ISelectCategor,@Iid,@IProductDate,@IExpireDate)");
                ...
                insertCommand.Parameters.AddWithValue("@IProductDate", IProductDate);
                insertCommand.Parameters.AddWithValue("@IExpireDate", IExpireDate);
        ...
        private void ProductDate_Enter(object sender, EventArgs e)
        {
            ProductDate.Text = "";
        }

        private void ProductDate_Leave(object sender, EventArgs e)
        {
           if (ProductDate.Text == "") ProductDate.Text = "Enter Product Date";
        }

        private void ExpireDate_Leave(object sender, EventArgs e)
        {
           if(ExpireDate.Text == "") ExpireDate.Text =  "Enter Expire Date";
        }

        private void ExpireDate_Enter(object sender, EventArgs e)
        {
            ExpireDate.Text = "";
        }
    }
