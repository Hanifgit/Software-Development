...
<body>
    <div class="row">
        <div class="col-sm-12">
            <div class="well">
                <center><h1 style="color: white;">BUBT FAMILY</h1></center>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-6" style="left:0.5%;">
            <img src="images/background.jpg" class="img-rounded" title="Bubt Family" width="650px" height="565px">
        ...
        <div class="col-sm-6" style="left:8%:">
            ...
            <h4><strong>Join Bubt Family Today.</strong></h4>
